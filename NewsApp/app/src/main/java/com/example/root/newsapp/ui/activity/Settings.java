...
import com.example.root.newsapp.helper.Language;
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if (preference.getKey().equals("language")) {
                    ...
                    Log.e("Text_Size", index == 0 ? "English" : "عربي");
                    if (index == 0/* && !first*/) {
                        Language.ChangeLanguage(preference.getContext(), "en");
                        //Intent intent = new Intent(preference.getContext(),Home.class);
                        //intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        //preference.getContext().startActivity(intent);
                        //first = true;

                    } else if (index == 1 /*&& !first*/) {
                        Language.ChangeLanguage(preference.getContext(), "ar");
                        //Intent intent = new Intent(preference.getContext(),Home.class);
                        //intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        //preference.getContext().startActivity(intent);
                        //first = true;
                ...
                } else if (preference.getKey().equals("font_size")){
                    ...
                    //Todo add functionality
                    Log.e("Text_Size", index == 0 ? "small" : index == 1 ? "medium" :"large");
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            nightMode.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    //todo NightMode Logic
                    Utility.doNightMode(test);
                    Log.e("NightMode", test == true ? "ON" : "OFF");
